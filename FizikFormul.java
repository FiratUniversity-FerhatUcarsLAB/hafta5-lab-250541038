...
public class FizikFormul {
    ...
    public static void main(String[] args) {
        ...
        double work = calculateWork(velocity, time);
        double power = calculatePower(work, time);
        double kineticEnergy = calculateKineticEnergy(velocity, acceleration);
        double potentialEnergy =  calculateMomentum(velocity, time);
        double powerMomentum = calculateMomentum(kineticEnergy, velocity);
        double momentum = calculateMomentum(power, kineticEnergy);
